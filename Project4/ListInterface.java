...
public interface ListInterface <T> {
    ...
    */
    ...
    /**
    * Adds new entry at specified position; shifts the entries
    to
    ...
    * @param anEntry
    * @return true if the entry was in the list; false
    otherwise
    */
    ...
    */
    ...
    /** Retrieves all entries that are in this list in the order
    they
    *occur in the list.
